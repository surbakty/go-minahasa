...
@section('content')
    <div class="container-fluid px-4 py-4">
        <div class="flex justify-between items-center mb-6">
            <div>
                <h1 class="text-2xl font-bold text-slate-800">Tambah Testimonial</h1>
                <p class="text-slate-500 text-sm">Masukkan ulasan positif dari pengunjung Go-Minahasa.</p>
            </div>
                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" name="name" placeholder="Contoh: Andini Putri"
                        ...
                        <div>
                            ...
                            <input type="text" name="profession" placeholder="Contoh: Travel Enthusiast"
                                class="w-full px-4 py-2.5 rounded-xl border border-slate-300 focus:ring-2 focus:ring-orange-500 outline-none transition-all">
                        </div>
                    </div>

                    {{-- Foto Profil (Versi Rapi) --}}
                    <div>
                        ...
                        <div class="flex items-center gap-5 p-4 border-2 border-slate-200 rounded-2xl bg-slate-50/50">
                            <div class="relative w-20 h-20 flex-shrink-0">
                                <div id="placeholder-icon"
                                    class="w-full h-full rounded-full bg-slate-200 flex items-center justify-center border-2 border-white shadow-sm">
                            ...
                            <div class="flex-1">
                                <div class="relative group">
                                    {{-- Input file asli disembunyikan tapi tetap bisa diklik --}}
                                    ...
                                    <div
                                        ...
                                        <span class="text-xs font-bold text-slate-500 group-hover:text-orange-600">
                                            <i class="fas fa-cloud-upload-alt mr-1"></i> Pilih Foto Pengunjung
                                        </span>
                                    </div>
                                </div>
                                <p class="text-[10px] text-slate-400 mt-2 ml-1 italic">Format: JPG, PNG (Maks. 2MB)</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="content" rows="4" placeholder="Tuliskan ulasan mereka di sini..."
                            class="w-full px-4 py-2.5 rounded-xl border border-slate-300 focus:ring-2 focus:ring-orange-500 outline-none transition-all"
                            required></textarea>
                    </div>
